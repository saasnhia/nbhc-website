...
const faqFr = [
  ...
  { question: "Quelle est la difference entre Vlogyz et CapCut ?", answer: "CapCut est un editeur video grand public. Vlogyz est un outil de montage IA automatise : il transcrit, detecte les silences et fillers, genere des sous-titres synchronises dans 13 styles, ajoute du B-Roll automatiquement et calcule un score de viralite. Vlogyz est heberge en Europe." },
  ...
  { question: "Vos solutions sont-elles conformes RGPD ?", answer: "Le traitement IA repose sur Mistral, un LLM francais heberge en Union europeenne, et l\u2019orchestration sur n8n, heberge en Allemagne. Au-dela de ce choix d\u2019infrastructure, la conformite RGPD de votre automatisation \u2014 quelles donnees elle traite, sous quelle base legale, avec quelles garanties \u2014 se cadre avec vous au diagnostic gratuit : chaque automatisation est differente, on ne peut pas la certifier avant de savoir ce qu\u2019elle touche." },
...
const faqEn = [
  ...
  { question: "Are your solutions GDPR-compliant?", answer: "AI processing runs on Mistral, a French LLM hosted in the European Union, and orchestration runs on n8n, hosted in Germany. Beyond that infrastructure choice, your automation's GDPR compliance — what data it processes, under what legal basis, with what safeguards — gets worked out with you at the free diagnostic: every automation is different, and we can't certify one before knowing what it touches." },
