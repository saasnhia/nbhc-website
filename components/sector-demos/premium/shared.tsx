...
export const Stage: React.FC<{
  ...
  <div
    style={{
      ...
      padding: pad,
      borderRadius: radius,
      background: `linear-gradient(150deg, ${SURFACE.cardHi} 0%, ${SURFACE.card} 55%, ${SURFACE.dim} 100%)`,
      border: `1px solid ${SURFACE.border}`,
      boxShadow: "0 46px 110px rgba(0,0,0,0.62), 0 6px 24px rgba(0,0,0,0.45)",
      display: "flex",
  ...
  >
    <div
      style={{
        ...
        borderRadius: radius,
        background:
          "linear-gradient(180deg, rgba(255,255,255,0.085) 0%, rgba(255,255,255,0.012) 22%, rgba(255,255,255,0) 46%)",
        pointerEvents: "none",
      }}
    />
    {children}
...
export const AnonRow: React.FC<{
  ...
  <div
    style={{
      ...
      padding: "0 30px",
      borderRadius: 16,
      background: highlighted ? COLORS.accentSoft : SURFACE.dim,
      border: `1px solid ${highlighted ? COLORS.accentBorder : SURFACE.borderSoft}`,
      opacity: dim,
      boxSizing: "border-box",
    }}
  >
